...
export class OrganizationClient extends EventEmitter {
    ...
    constructor(channelName, ordererConfig, peerConfig, caConfig, admin) {
        ...
        const orderer = this._client.newOrderer(this._ordererConfig.url, {
            pem: this._ordererConfig.pem,
            'ssl-target-name-override': this._ordererConfig.hostname
        });
    ...
    async createChannel(envelope) {
        ...
        // Wait for 10 sec to create channel
